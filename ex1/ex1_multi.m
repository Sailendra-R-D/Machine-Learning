...
%plot a  n-D figure
plot3(X(:,1), X(:,2),y, 'rx', 'MarkerSize', 10); % Plot the data
grid on;
xlabel('Area (in sq-ft)'); % Set the x-axis label
ylabel('rooms'); % Set the y-axis label
zlabel('Price (in dollars)'); % Set the z-axis label
